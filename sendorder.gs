// GDAX-API-Send-Order
// Uses most of the code as in code.gs


// Error 400: Unable to resolve as on 13.01.2018
// Would appreciate any help from Bruttagente and psysm
...
var response = UrlFetchApp.fetch(requestUrl, params);   // Error 400
